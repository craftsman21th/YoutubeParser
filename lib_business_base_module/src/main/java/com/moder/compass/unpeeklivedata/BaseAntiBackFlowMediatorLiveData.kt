...
/**
 * 防倒灌 MediatorLiveData 基类
 */
open class BaseAntiBackFlowMediatorLiveData<T> : MediatorLiveData<T> {
    ...
    internal inner class ObserverWrapper(observer: Observer<in T>, version: Int) : Observer<T?> {
        ...
        override fun equals(that: Any?): Boolean {
            return mObserver == (that as? BaseAntiBackFlowMediatorLiveData<*>.ObserverWrapper)?.mObserver
        }
