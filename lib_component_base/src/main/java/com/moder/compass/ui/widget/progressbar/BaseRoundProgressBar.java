...
public abstract class BaseRoundProgressBar extends LinearLayout {
    ...
    public void setupStyleable(Context context, AttributeSet attrs) {
        ...
        int colorBackgroundDefault = context.getResources().getColor(R.color.gray);
        colorBackground = typedArray.getColor(R.styleable.RoundCornerProgress_rcBackgroundColor,
                colorBackgroundDefault);
        int colorProgressDefault = context.getResources().getColor(R.color.blue);
        colorProgress = typedArray.getColor(R.styleable.RoundCornerProgress_rcProgressColor, colorProgressDefault);
        int colorSecondaryProgressDefault = context.getResources().getColor(R.color.red);
    ...
    private void drawBackgroundProgress() {
        ...
        backgroundDrawable.setCornerRadii(new float[]{newRadius, newRadius, newRadius, newRadius,
    ...
    public interface OnProgressChangedListener {
        public void onProgressChanged(int viewId, float progress,
                                      boolean isPrimaryProgress, boolean isSecondaryProgress);
    }
}
