package com.mars.united.international.webplayer.core.customui.views
...
import com.mars.united.international.webplayer.core.customui.utils.TimeUtilities
...
class YouTubePlayerSeekBar(context: Context, attrs: AttributeSet? = null) :
  ...
  override fun onPlaybackQualityChange(
    ...
    DuboxLog.d("qqqq","playbackQuality:${playbackQuality.name}")
  }
  ...
  override fun onPlaybackRateChange(
    ...
    DuboxLog.d("qqqq","playbackRate:${playSpeedRate.name}")
  }
