...
interface YouTubePlayer {
   ...
   * @param rate 播放速度
   * */
  fun setPlaySpeedRate(rate: PlayerConstants.PlaySpeedRate)

  /**
   * 设置播放分辨率
   * @param quality 播放分辨率
   * */
  fun setPlaybackQuality(quality: PlayerConstants.PlaybackQuality)

  /**
   * 读取播放分辨率
   * 内容通过 @see YouTubePlayerBridge#sendVideoQuality
   *
   * */
  fun loadVideoQuality()
