package com.mars.united.international.webplayer.core.player.listeners
...
interface YouTubePlayerListener {
    ...
    /**
     * Called every time the speed of the playback changes. Check [PlayerConstants.PlaySpeedRate] to see all the possible values.
     * @param playSpeedRate a state from [PlayerConstants.PlaySpeedRate]
     */
    fun onPlaybackRateChange(
        youTubePlayer: YouTubePlayer,
        playSpeedRate: PlayerConstants.PlaySpeedRate
    )
    ...
    /**
     * Called when the id of the current video quality info is ready
     * @param qualityInfo the video quality info
     * */
    fun onVideoQualityInfoReady(
        youTubePlayer: YouTubePlayer,
        videoId: String?,
    ...
    /**
     * Called when the player api is change
     * */
