...
import com.mars.united.international.webplayer.core.player.listeners.YouTubePlayerCallback
...
import com.mars.united.international.webplayer.core.player.utils.NetworkObserver
import com.mars.united.international.webplayer.core.player.utils.PlaybackResumer
...
internal class LegacyYouTubePlayerView(
    ...
    internal val webViewYouTubePlayer = WebViewYouTubePlayer(context, listener).apply {
        settings.apply {
    ...
    fun toggleFullscreen() {
        webViewYouTubePlayer.toggleFullscreen()
    }
}
