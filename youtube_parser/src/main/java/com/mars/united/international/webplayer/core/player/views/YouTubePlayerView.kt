...
import com.mars.united.international.webplayer.core.player.listeners.*
import com.mars.united.international.webplayer.core.player.options.IFramePlayerOptions
import com.mars.united.international.webplayer.core.player.utils.loadOrCueVideo
...
class YouTubePlayerView(
    ...
    var listener: YouTubePlayerListener? = null
        private set
    ...
    init {
        ...
        val youTubePlayerListener = object : AbstractYouTubePlayerListener() {
            ...
            override fun onVideoQualityInfoReady(
                ...
                DuboxLog.d("qqqq","legacyTubePlayerView#youTubePlayerListener#onVideoQualityInfoReady${qualityInfo.toString()},$curQuality")
            }
        }
    ...
    fun initialize(
        ...
        listener = youTubePlayerListener
        if (enableAutomaticInitialization) {
